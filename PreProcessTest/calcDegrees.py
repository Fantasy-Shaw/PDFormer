...
class DegreeStatistics:
    ...
    def vis_edge(self):
        ...
        bax = brokenaxes(ylims=((0, 60), (730, 760)), hspace=.1, despine=True)
        bax.set_title('Edge Weights in PeMSD7')
        bax.set_xlabel("Weights")
        bax.set_ylabel("Nums")
        bax.bar(self.roadStatusStat.weight, self.roadStatusStat.nums)
    ...
    def vis_node(self):
        ...
        bax.set_title("Node Weights in PeMSD7")
        bax.set_xlabel("Nums")
